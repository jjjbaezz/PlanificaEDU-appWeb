<template>
  ...
  <div class="flex items-center justify-center min-h-screen bg-gray-100 p-4">
    <div class="bg-white rounded-2xl shadow-lg p-8 max-w-2xl w-full">
      <!-- Header -->
      <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Crear Nuevo Estudiante</h2>
        <p class="text-gray-500 text-sm mt-1">Rellena los siguientes campos para añadir un nuevo estudiante al sistema.</p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div>
          ...
          <p class="text-gray-500 text-sm mb-4">Selecciona los bloques horarios en los que prefieres tener clases.</p>
